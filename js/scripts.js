...
/*
    Template Name   : Appsun .
    Template URI    : http://m-alaa.com/appsun/layout.html
    Description     : Company .
    Author          : Mohamed Alaa Abas
    Author URI      : https://themeforest.net/user/m-alaa
    Author Facebook : https://www.facebook.com/profile.php?id=100004522147924 
    Author Email    : mohamed_ll14@yahoo.com 
*/
// Fuction Loading Page 
// Use Jquery To Animation When Load . 
'use strict';
$(window).on("load", function () {
    // Class Of Body 
    $(".body").fadeOut().delay(200).remove();
